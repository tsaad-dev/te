...
This document also requests IANA to update the following YANG modules to the "YANG Module
...
> RFC Editor: The YANG trees have been generated by pyang and have some bugs to be fixed before publication. Please contact the authors to get the fixed version of the YANG trees, replace the YANG trees below with the fixed version and remove this note.
